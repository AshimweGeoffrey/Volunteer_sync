...
var organizations = [
  {
    ...
    description:
      "Environmental conservation and sustainability organization focused on protecting natural resources and promoting eco-friendly practices.",
    contactInfo: {
  ...
  },
  {
    ...
    description:
      "Fighting hunger in our community by providing food assistance to families and individuals in need.",
    contactInfo: {
  ...
  },
  {
    ...
    description:
      "Empowering youth through educational programs, mentorship, and skill development initiatives.",
    contactInfo: {
  ...
  },
  {
    ...
    description:
      "Providing support and companionship to elderly community members through various assistance programs.",
    contactInfo: {
  ...
  },
  {
    ...
    description:
      "Rescuing, rehabilitating, and finding homes for abandoned and abused animals in our community.",
    contactInfo: {
...
var users = [
  {
    ...
    isActive: true,
    passwordHash:
      "$2a$12$kcZsQC0V3npOAF2f77pUquLQjPAz37dkzEJcEcKrRRRDFE8mJQ2mi", // hashed "password123"
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    isActive: true,
    passwordHash:
      "$2a$12$kcZsQC0V3npOAF2f77pUquLQjPAz37dkzEJcEcKrRRRDFE8mJQ2mi",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
...
var tasks = [
  // Green Earth Foundation tasks
  {
    ...
    description:
      "Help establish a new community garden by preparing soil, planting seeds, and setting up irrigation systems.",
  ...
  },
  {
    ...
    description:
      "Join us for a coastal cleanup to remove trash and debris from local beaches and waterways.",
    organizationId: orgIds[0],
  ...
  // Community Food Bank tasks
  {
    ...
    description:
      "Sort donated food items and package them into family-sized portions for distribution.",
  ...
  },
  {
    ...
    description:
      "Help distribute food to families at various community locations using our mobile food truck.",
    organizationId: orgIds[1],
    category: 3, // CommunityService
  ...
  // Youth Education Alliance tasks
  {
    ...
    description:
      "Provide one-on-one tutoring support for elementary and middle school students in various subjects.",
  ...
  },
  {
    ...
    description:
      "Lead hands-on science, technology, engineering, and math workshops for high school students.",
    organizationId: orgIds[2],
    category: 0, // Education
  ...
  // Senior Care Network tasks
  {
    ...
    description:
      "Spend time with elderly residents, engaging in conversation, games, and light activities.",
  ...
  },
  {
    ...
    description:
      "Teach seniors how to use smartphones, tablets, and computers to stay connected with family.",
    organizationId: orgIds[3],
    category: 0, // Education
  ...
  // Animal Rescue Alliance tasks
  {
    ...
    description:
      "Help exercise our rescue dogs by taking them on walks and providing playtime.",
  ...
  },
  {
    ...
    description:
      "Help maintain clean and sanitary conditions at our animal shelter facilities.",
    organizationId: orgIds[4],
    category: 4, // AnimalWelfare
...
users.forEach(function (user, userIndex) {
  ...
  for (
    var i = 0;
    i < numberOfRegistrations && i < shuffledTaskIds.length;
    i++
  ) {
    registrations.push({
      ...
      registeredAt: new Date(
        now.getTime() - (Math.floor(random() * 10) + 1) * 24 * 60 * 60 * 1000
      ), // 1-10 days ago
      approvedAt:
        random() < 0.8
          ? new Date(
              now.getTime() -
                (Math.floor(random() * 5) + 1) * 24 * 60 * 60 * 1000
            )
          : null,
      notes: "",
      createdAt: new Date(),
...
for (var i = 0; i < 5; i++) {
  ...
  registrations.push({
    ...
    status: 3, // Completed
    registeredAt: new Date(
      now.getTime() - (Math.floor(random() * 30) + 30) * 24 * 60 * 60 * 1000
    ), // 30-60 days ago
    approvedAt: new Date(
      now.getTime() - (Math.floor(random() * 25) + 25) * 24 * 60 * 60 * 1000
    ), // 25-55 days ago
    completedAt: new Date(
      now.getTime() - (Math.floor(random() * 5) + 1) * 24 * 60 * 60 * 1000
    ), // 1-5 days ago
...
print(
  "🎉 Production database seeding completed successfully with correct structure!"
);
